<template>
  <div>
    <v-app>
      ...
      <v-main>
        <v-card v-for="vegetable in vegetables"
            :key="vegetable" width="100%" outlined class="mt-6 mb-3">
          <v-list-item
          >
            <v-list-item-content>
              <div class="overline mb-4">VEGETABLE</div>
          ...
          <v-card-actions>
            <v-btn @click="showIngredients(vegetable.id)" outlined rounded text> See Ingredient </v-btn>
          </v-card-actions>
        </v-card>
      </v-main>
    </v-app>
